...
// TODO: make the rotation functions return NULL on allocation error & document this
...
{
	struct sptree_node *node, *sibling;
...
error:
	// parent is the head of the preallocated subtree
	_delete_prealloc(parent);
